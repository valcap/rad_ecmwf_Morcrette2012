...
REAL(KIND=JPRB) , DIMENSION(4,5)   :: RTAUA=RESHAPE((/&
 ...
 & ,SHAPE=(/4,5/))  
REAL(KIND=JPRB) , DIMENSION(4,5)   :: RPIZA=RESHAPE((/&
 ...
 & ,SHAPE=(/4,5/))  
REAL(KIND=JPRB) , DIMENSION(4,5)   :: RCGA=RESHAPE((/&
...
REAL(KIND=JPRB) , DIMENSION(5,5)   :: RAER=RESHAPE((/&
