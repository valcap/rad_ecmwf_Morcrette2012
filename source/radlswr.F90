...
RRe2De = 0.64952_JPRB !!! Andrea: definito come indicato da Morcrette (ice elongated cyclinders)
ZRefDe = RRe2De
...
IF(ZRMUZ.LT.1.E-10_JPRB) GOTO 345 ! Andrea: jump all SW radiation routines (prevents errors and saves time)
