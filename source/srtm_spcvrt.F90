...
SUBROUTINE SRTM_SPCVRT &
 & ( KIDIA   , KFDIA    , KLEV    , KMOL    , KSW    , PONEMINUS, &
...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PFRCL(KIDIA:KFDIA,JPLAY)     ! bottom to top
REAL(KIND=JPRB)   ,INTENT(IN)    :: PTAUC(KIDIA:KFDIA,JPLAY,KSW) ! bottom to top
REAL(KIND=JPRB)   ,INTENT(IN)    :: PASYC(KIDIA:KFDIA,JPLAY,KSW) ! bottom to top
REAL(KIND=JPRB)   ,INTENT(IN)    :: POMGC(KIDIA:KFDIA,JPLAY,KSW) ! bottom to top
...
ENDDO
 ...
 IF(VIS_FLAG.EQ.0) RETURN ! Andrea
