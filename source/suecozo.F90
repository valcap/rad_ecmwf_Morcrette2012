...
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZQC0=(/&
 ...
 & +.1333E-03_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZQS0=(/&
 ...
 & -.1375E-04_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZHC0=(/&
 ...
 & +.1693E+02_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZHS0=(/&
 ...
 & -.2676E+01_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZQC1=(/&
 ...
 & -.1780E-04_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZQS1=(/&
 ...
 & +.1116E-04_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZHC1=(/&
 ...
 & -.3169E+01_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZHS1=(/&
 ...
 & +.2032E+01_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZQC2=(/&
 ...
 & -.1936E-06_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZQS2=(/&
 ...
 & -.2391E-05_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZHC2=(/&
 ...
 & +.1132E+01_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZHS2=(/&
 ...
 & -.7579E+00_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZQC3=(/&
 ...
 & +.8852E-05_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZQS3=(/&
 ...
 & +.2506E-05_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZHC3=(/&
 ...
 & +.1228E+01_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZHS3=(/&
 ...
 & +.2648E+00_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZQC4=(/&
 ...
 & +.3686E-05_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZQS4=(/&
 ...
 & +.1954E-05_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(21) :: ZOZHC4=(/&
 ...
 & -.3074E+00_JPRB/)  
REAL(KIND=JPRB) ,DIMENSION(15) :: ZOZHS4=(/&
...
INTEGER(KIND=JPIM) :: JMN

REAL(KIND=JPRB) :: ZC1YT, ZC2YT, ZS1YT, ZS2YT, ZYTIME
...
ZS2YT=2.0_JPRB*ZS1YT*ZC1YT
DO JMN=1,21
  COZQC(JMN)=ZOZQC0(JMN)+2.0_JPRB*(ZOZQC1(JMN)*ZC1YT+ZOZQC2(JMN)*ZS1YT &
   & +ZOZQC3(JMN)*ZC2YT+ZOZQC4(JMN)*ZS2YT)  
  COZHC(JMN)=ZOZHC0(JMN)+2.0_JPRB*(ZOZHC1(JMN)*ZC1YT+ZOZHC2(JMN)*ZS1YT &
   & +ZOZHC3(JMN)*ZC2YT+ZOZHC4(JMN)*ZS2YT)  
ENDDO
DO JMN=1,15
  COZQS(JMN)=ZOZQS0(JMN)+2.0_JPRB*(ZOZQS1(JMN)*ZC1YT+ZOZQS2(JMN)*ZS1YT &
   & +ZOZQS3(JMN)*ZC2YT+ZOZQS4(JMN)*ZS2YT)  
  COZHS(JMN)=ZOZHS0(JMN)+2.0_JPRB*(ZOZHS1(JMN)*ZC1YT+ZOZHS2(JMN)*ZS1YT &
